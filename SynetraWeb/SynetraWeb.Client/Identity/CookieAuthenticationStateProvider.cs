...
using System.Text;
using SynetraWeb.Client.Identity.Models;
using System.Net.Http;


namespace SynetraWeb.Client.Identity
{
    /// <summary>
    ...
    public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
    {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                var userInfo = JsonSerializer.Deserialize<SynetraWeb.Client.Identity.Models.UserInfo>(userJson, jsonSerializerOptions);
